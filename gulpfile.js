 ...
 */
gulp.task('default', gulp.series('sass', 'coffee', 'browser-sync'), function () {
    gulp.watch(PATHS.scripts, gulp.series('coffee', reload));
    gulp.watch(PATHS.styles_all, gulp.series('sass'));
});

/**
 * Minify JS/CSS
 */
gulp.task('min', gulp.series('js-min', 'css-min'));
